...
class ConditionalShift:
    ...
    def __init__(
        ...
        verbose: bool=False,
        mode: Literal["rf_quantiles", "gbr_quantiles"] = "rf_quantiles",
    ):
        """
        Args:
            ...
            mode (str): The method to use for estimating quantiles. Options are
                "rf_quantiles" for Random Forest-based quantile regression or
                "gbr_quantiles" for Gradient Boosting Regression-based quantile
                regression. The default is "rf_quantiles".
        """
    ...
    def fit(self, X, error):
        ...
        for train, test in tqdm(
            ...
            if self.mode == "rf_quantiles":
                self._fit_rf_quantiles(X_i, mu_train, train, test)
    ...
    def _fit_rf_quantiles(self, X_i, mu_train, train, test):
